...
class News {
   public:
	struct Cols {
		...
		static const std::string _original_text;
		static const std::string _source_url;
	};
	 ...
	 */
	explicit News(const drogon::orm::Row& r,
	...
	/**  For column original_text  */
	/// Get the value of the column original_text, returns the default value if
	/// the column is null
	const std::string& getValueOfOriginalText() const noexcept;
	/// Return a shared_ptr object pointing to the column const value, or an
	/// empty shared_ptr object if the column is null
	const std::shared_ptr<std::string>& getOriginalText() const noexcept;
	/// Set the value of the column original_text
	void setOriginalText(const std::string& pOriginalText) noexcept;
	void setOriginalText(std::string&& pOriginalText) noexcept;

	/**  For column source_url  */
	/// Get the value of the column source_url, returns the default value if the
	/// column is null
	const std::string& getValueOfSourceUrl() const noexcept;
	/// Return a shared_ptr object pointing to the column const value, or an
	/// empty shared_ptr object if the column is null
	const std::shared_ptr<std::string>& getSourceUrl() const noexcept;
	/// Set the value of the column source_url
	void setSourceUrl(const std::string& pSourceUrl) noexcept;
	void setSourceUrl(std::string&& pSourceUrl) noexcept;
	void setSourceUrlToNull() noexcept;
   ...
   private:
	friend drogon::orm::Mapper<News>;
	friend drogon::orm::BaseBuilder<News, true, true>;
	friend drogon::orm::BaseBuilder<News, true, false>;
	friend drogon::orm::BaseBuilder<News, false, true>;
	friend drogon::orm::BaseBuilder<News, false, false>;
#ifdef __cpp_impl_coroutine
	friend drogon::orm::CoroMapper<News>;
#endif
	...
	std::shared_ptr<std::string> originalText_;
